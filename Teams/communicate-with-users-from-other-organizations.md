...
<sup>6</sup> If sharing settings in OneDrive and SharePoint admin center are set to "Anyone", read [Manage sharing settings](turn-external-sharing-on-or-off.md). <br>
